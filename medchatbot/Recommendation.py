...
df=pd.read_csv("disese predictor\Disease-Prediction-from-Symptoms\Training.csv")
...
tr=pd.read_csv("disese predictor\Disease-Prediction-from-Symptoms\Testing.csv")
